				...
				<div class="col-md-8 col-lg-9 p-b-80 p-t-55 order-md-2" style="padding-left: 15px; padding-fight: 15px">
					...
					<div class="table-responsive">
						<div class="box gray-box title" style="margin:30px 0">
							<div class="form-container p-b-10 p-lr-10" style="display:table-row;float:left;width:100%">
								...
								<a href="orderReturn.do?interval=1" class="btn type01" style="float:left">하루</a>
								<a href="orderReturn.do?interval=7" class="btn type01" style="float:left">일주일</a>
								<a href="orderReturn.do?interval=30" class="btn type01" style="float:left">1개월</a>
								<a href="orderReturn.do?interval=90" class="btn type01" style="float:left">3개월</a>
							</div>
							<!-- 주문별 일자 조회 -->
							<div class="form-container p-t-10 p-lr-10" style="display:table-row;float:left">
								...
								<div>
									<form name="orderDateForm" action="orderReturn.do" method="get">
					...
					<div class="orderlist">
						<table>
							...
							<tbody>
								<c:forEach items="${allRefundList}" var="order">
									<tr>
										<td>
										...
										<!-- 구매한 책이 1권인 경우 1권의 제목만 노출. 20자가 넘을 경우 뒷부분 생략 -->
										...
										<!-- 구매한 책이 2권 이상일 경우 대표 1권의 제목만 올리고 나머지는 '외 n권'으로 표시. 15자 넘으면 생략 -->
